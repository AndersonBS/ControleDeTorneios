...
public class PopulaDB {
    ...
    public static void main(String[] args) {
        ...
        equipeDAO.save(new Equipe("Equipe 1", new Date("01/01/2015"), "equipe1@gmail.com", "www.equipe1.com.br", "(49)1234-5678"));
        equipeDAO.save(new Equipe("Equipe 2", new Date("02/02/2015"), "equipe2@gmail.com", "www.equipe2.com.br", "(49)2345-6789"));
        equipeDAO.save(new Equipe("Equipe 3", new Date("03/03/2015"), "equipe3@gmail.com", "www.equipe3.com.br", "(49)3456-7890"));
        equipeDAO.save(new Equipe("Equipe 4", new Date("04/04/2015"), "equipe4@gmail.com", "www.equipe4.com.br", "(49)0123-4567"));
        equipeDAO.save(new Equipe("Equipe 5", new Date("05/05/2015"), "equipe5@gmail.com", "www.equipe5.com.br", "(49)9012-3456"));
